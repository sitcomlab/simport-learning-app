...
/*
TODO to what degree can we assume correctness of input trajectory?
    - length of coordinates and timestamps is the same
    - dates are in ascending order
    - there are no missing values
*/

// compute staypoints based on trajectory
// based on Li et al 2008, "Mining User Similarity Based on Location History"
